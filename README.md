...
See [Documentation](http://hsisomap.github.io/hsisomap/). 
...
Optionally, the [Documentation](http://hsisomap.github.io/hsisomap/) can be generated by Doxygen:

- Doxygen `1.8.13`

The commandline tool and GUI tool also use a 3rd-party header file [PicoJSON](https://github.com/kazuho/picojson) `1.3.1-dev`. The file is included in the repository and does not need to be installed separately. 
...
The official website contains full [documentation](http://hsisomap.github.io/hsisomap/) of the source code. If you need a local copy, please use Doxygen to generate them locally. 
...
The full documentation of the project is generated by Doxygen. [Click here to view the documentation](http://hsisomap.github.io/hsisomap/).  If you want to generate documentation locally, refer to "Build" section. 
